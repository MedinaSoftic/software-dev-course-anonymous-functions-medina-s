...
const todos = [
  ...
  */
  ...
  let todoTasks = todos.filter(((todos) => !Boolean(todos.completed)));
  ...
  */
  ...
  console.log("Incomplete Tasks:", todoTasks);
  console.log("Sorted by Priority:", priorityTasks);
  console.log("All Tasks Completed:", completedTasks);
  console.log("Sorted Incomplete Tasks:", incompletedTasksSorted);
